...
| `adosc`               | int           | high, low, close, volume | yes | —   | —                          | 9  |
...
| `obv`                 | int           | close, volume            | yes | —   | —                          | 0  |
| `ppo`                 | int           | close                    | yes | —   | —                          | 25 |
